...
@Service
@Slf4j
public class BlockfrostAdapterPreprod implements BlockfrostQueryAdapter {

    private WebClient blockfrostWebClient;

    public BlockfrostAdapterPreprod(@Qualifier("blockfrostPreprodClient") WebClient blockfrostWebClient) {
